    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/advert" method="post" enctype="multipart/form-data">
            <div class="mws-form-inline">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" name="ad_name" class="large" value="{{$rs->ad_name}}">
                    </div>
                </div>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <textarea rows="" cols="" name="ad_desc" class="large" value="{{$rs->ad_desc}}"></textarea>
                    </div>
                </div>
            ...
            <div class="mws-button-row">
                <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">
                        <input type="submit" value="修改广告" class="btn btn-info">
                    </font>
                </font>
            </div>
        </form>
