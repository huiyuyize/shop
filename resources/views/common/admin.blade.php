        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    ...
                    <li>
                        <a href="#"><i class="icon-cogs"></i>用户管理</a>
                        <ul class='closed'>
                    ...
                    <li>
                        <a href="#"><i class="icon-cogs"></i>管理员管理</a>
                        <ul class='closed'>
                    ...
                    <li>
                        <a href="#"><i class="icon-atom"></i>品牌管理</a>
                        <ul class='closed'>
                            <li><a href="/admin/brand">添加品牌</a></li>
                            <li><a href="/admin/brandlist">品牌列表</a></li>
                        </ul>
                    </li>    
                    <li>
                        <a href="#"><i class="icon-share-2"></i>商品分类管理</a>
                        <ul class='closed'>
                            <li><a href="/admin/insert/goods">添加分类</a></li>
                    ...
                    <li>
                        <a href="#"><i class="icon-rocket"></i>订单管理</a>
                        <ul class='closed'>
