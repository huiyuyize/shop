            ...
            <div class="m_des">
                ...
                <table border="0" style="width:880px;"  cellspacing="0" cellpadding="0">
                  ...
                  <tr height="65">
                    ...
                    <td><input type="password" value="" class="add_ipt" id="add" style="width:180px;" name="newpassword"/>&nbsp; <font class="password" color="#ff4e00">*</font></td>
                  </tr>
                  <tr height="65">
                    <td align="right">确认密码 &nbsp; &nbsp;</td>
                    <td><input type="password" value="" class="add_ipt" id="readd" style="width:180px;" name="repassword"/>&nbsp; <font class="repassword" color="#ff4e00">*</font></td>
                  </tr>
                  <tr height="50">
                    <td>&nbsp;</td>
                    <td><input type="submit" value="确定" class="btn_tj" /></td>
                  </tr>
                </table>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    $('form').submit(function(){
        ...
        console.log(b);*/
         ...
         var password = /^(\w){6,20}$/;
          if(!password.test($('#add').val())){
      　　       $('.password').text('错误!密码由6-20位组成！');
      ...
      if(a != b){
            ...
            $('#readd').css('border-color','red');
            return false;
        }else {
            $('.repassword').text('*');
            $('#readd').css('border-color','');
            
            $.post('/newpassword',{"new":a, "_token":"{{csrf_token()}}"},function(data){
                 if(data == 1){
                    alert("修改成功,请牢记您的密码");
                    location.href="/login";
                 }else{
