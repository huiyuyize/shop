...
<div class="soubg">
	<div class="sou">
        ...
        <span class="fr">
            @if(session('username'))
            <span class="fl">欢迎回来!&nbsp;{{session('username')}}&nbsp;|&nbsp;<a href="/loginout">退出</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
            @else
        	<span class="fl">你好，请<a href="/login">登录</a>&nbsp; <a href="/add" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
            @endif
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="top">
    ...
    <div class="search">
    	...
    	<form action="/list/1" method="get" >
        	<input type="text" name="gname"  value="" class="s_ipt" />
    ...
    <div class="i_car">
    	<div class="car_t"><a href="/home/goodscar">购物车 </a></div>
        <div class="car_bg">
            @if(!session('userid'))
       		<!--Begin 购物车未登录 Begin-->
            ...
            <div class="price_a"><a href="/home/goodscar/goodscar">去购物车结算</a></div>
            <!--End 购物车已登录 End-->
            @endif
        </div>
    </div>
            ...
            <div class="leftNav">
                <ul>
                   @foreach($pid_data as $k=>$v)     
                    <li>
                        <a href="/list/{{$v->id}}" style="color:white">
                    	<div class="fj">
                        ...
                        <div class="zj">
                            <div class="zj_l">
                                ...
                                <div class="zj_l_c">
                                    ...
                                    <h2>{{$vs->cate_name}}</h2>
                                    @foreach($vs['sub'] as $kss=>$vss)
                                    <a href="/list/{{$vss->id}}">{{$vss->cate_name}}</a>|
                                    @endforeach
                                </div>
                                @endforeach
                            </div>
...
<div class="i_bg bg_color">
	<div class="i_ban_bg">
        ...
        <div class="inews">
        	<div class="news_t">
            	<span class="fr"><a href="#">更多</a></span>广告区域
            </div>
            <ul>
                 @foreach($advert as $k=>$v)
                <li><span>[ 广告 ]</span><a href="/guanggao/{{$v->id}}">{{$v->ad_name}}</a></li>
                @endforeach
            </ul>
        </div>
    </div>
...
@show
                            ...
                            <ul class="featureUL">
                                ...
                                <li class="featureBox">
                                    <div class="box">
                                        ...
                                        <div class="imgbg">
                                            <a href="/detail/{{$v->id}}"><img src="{{$v->goods_img}}" width="160" height="136" /></a>
                                        </div>                                        
                                        <div class="name">
                                            <a href="#">
                                            <h2>{{$v->goods_name}}</h2>
	...
	<!--Begin 进口 生鲜 Begin-->
    <div class="i_t mar_10"><a name="shengxian">
    ...
    <!--End 进口 生鲜 End-->
    <!--Begin 食品饮料 Begin-->
    <div class="i_t mar_10"><a name="meishi">
    ...
    <!--End 食品饮料 End-->
    <!--Begin 个人美妆 Begin-->
    <div class="i_t mar_10"><a name="meizhuang">
    ...
    <!--End 个人美妆 End-->
    <div class="content mar_20"><a name="muying">
    	<img src="/static/home/images/mban_1.jpg" width="1200" height="110" />
    </div>
    <!--Begin 母婴玩具 Begin-->
    <div class="i_t mar_10">
    ...
    <!--End 母婴玩具 End-->
    <!--Begin 家居生活 Begin-->
    <div class="i_t mar_10"><a name="jiaju">
    ...
    <!--End 家居生活 End-->
    <!--Begin 数码家电 Begin-->
    <div class="i_t mar_10"><a name="shuma">
    ...
    <!--End 数码家电 End-->
    <!--Begin 猜你喜欢 Begin-->
    <div class="i_t mar_10"><a name="caini">
    ...
    <div id="link">
        ...
        <div class="link">
            @foreach($link as $k=>$v)
            <span><a href="{{$v->link_url}}" target="_blank"><img src="{{$v->link_logo}}" width="60px"></a></span>
            @endforeach
        </div>
